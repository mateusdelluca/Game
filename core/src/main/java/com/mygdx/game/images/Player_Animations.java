...
public enum Player_Animations implements Serializable {
    ...
    ATTACK_JUMP(new Animator(1,1,1,128,128, "boy/AttackJump.png")),
    ...
    ATTACKING_SWORD_FIRE_2(new Animator(12,12,5,192,128,"boy/Sword_Fire_2Hits_3.png")),
    ...
    JUMPING_FRONT_LASER((new Animator(3,3,3,128, 128,"boy/Jumping_Headset_Sheet.png"))),
    ...
    HEADSET(new Animator(3,3,3,42, 50,"boy/Laser_HeadSet-Sheet3.png")),
