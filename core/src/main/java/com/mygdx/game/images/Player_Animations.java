...
public enum Player_Animations implements Serializable {
    ...
    ATTACK_JUMP(new Animator(1,1,1,1,128,128, "boy/AttackJump.png")),
    ...
    WALKING_SWORD(new Animator(6,6,12,128,128,"boy/Walking_Sword.png")),
    ...
    WALKING(new Animator(6,6, 12, 128, 128, "boy/Walking.png")),
